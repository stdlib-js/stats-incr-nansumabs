...
var incrnansumabs = require( './../../dist' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof incrnansumabs, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function returns an accumulator function', function test( t ) {
	t.equal( typeof incrnansumabs(), 'function', 'returns a function' );
	t.end();
});

tape( 'the initial accumulated value is `null`', function test( t ) {
	var acc = incrnansumabs();
